...
const VideoTitle = ({ title, overview }) => {
  return (
    <div className="pt-[60%] md:pt-[15%] pl-5 md:pl-12 absolute text-white bg-gradient-to-r from-black w-full aspect-video">
      <h1 className="text-xl md:text-4xl lg:text-6xl font-bold w-1/3 mb-2 md:mb-4 -mt-10 md:mt-4 lg:mt-0">
        {title}
      </h1>
